...
% Analysis of flux 
[X,Y] = flux_analysis(result_p1,result_p2,result_p12,Gut_community,Max_growth);
Y = (Y./sum(Y,2))*100;
bar(Y);
...
function [X,Y] = flux_analysis(community_1,community_2,community_3,gut_community,maxgrowth)
k=1;
for k =1:3
    if k==1 
...
if length(num) > 1
   ...
   for l =1 : length(num)
    ...
    if k == 1
        ...
        increasingexcrxns_1 = increasing_flux_rxns; decreasingexcrxns_1 = decreasing_flux_rxns;
    elseif k == 2
        increasingfluxrxns_2 = increasing_flux_rxns; decreasingfluxrxns_2 = decreasing_flux_rxns;
        increasingexcrxns_2 = increasing_flux_rxns; decreasingexcrxns_2 = decreasing_flux_rxns;
    else
        increasingfluxrxns_12 = increasing_flux_rxns; decreasingfluxrxns_12 = decreasing_flux_rxns;
        increasingexcrxns_12 = increasing_flux_rxns; decreasingexcrxns_12 = decreasing_flux_rxns;
    end
    k=k+1;
end
